...
namespace InventoryManagement.BusinessObjects.Entities
{
    ...
    [ConnectionKey("Default"), DisplayName("PurchasesUOMsAndPrices"), InstanceName("Purchases UoM and Price"), TwoLevelCached]
    [ReadPermission(BusinessObjects.PermissionKeys.PurchasesUoMAndPrice.Read)]
    [InsertPermission(BusinessObjects.PermissionKeys.PurchasesUoMAndPrice.Insert)]
    [UpdatePermission(BusinessObjects.PermissionKeys.PurchasesUoMAndPrice.Update)]
    [DeletePermission(BusinessObjects.PermissionKeys.PurchasesUoMAndPrice.Delete)]
    [LookupScript("BusinessObjects.PurchasesUoMAndPrice")]
    public sealed class PurchasesUoMAndPriceRow : Row, IIdRow, INameRow
    {

        #region Uom And Price Id
        [DisplayName("Uom And Price Id"), Column("UOMAndPriceID"), Identity, LookupInclude]
        ...
        #region Unit Make Up
        [DisplayName("Unit Make Up"), Size(18), NotNull, LookupInclude]
        ...
        {
            get { return Fields.UnitOfMeasurement[this]; }
            set { Fields.UnitOfMeasurement[this] = value; }
        }

        [NotMapped]
        public string StandardUnitName
        {
            get { return Fields.StandardUnitName[this]; }
            set { Fields.UnitOfMeasurement[this] = value; }
        }
        ...
        #region Constructor
        public PurchasesUoMAndPriceRow()
            : base(Fields)
        {
        }
        ...
        {
            public RowFields()
                : base("[dbo].[PurchasesUOMsAndPrices]")
            {
                LocalTextPrefix = "BusinessObjects.PurchasesUoMAndPrice";
            }


            public StringField UnitOfMeasurement;
            public StringField StandardUnitName;
