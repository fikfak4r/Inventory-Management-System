...
namespace InventoryManagement.BusinessObjects.Entities
{
    ...
    [ConnectionKey("Default"), DisplayName("Invoice"), InstanceName("Invoice"), TwoLevelCached]
    [ReadPermission(BusinessObjects.PermissionKeys.SalesInvoice.Read)]
    [InsertPermission(BusinessObjects.PermissionKeys.SalesInvoice.Insert)]
    [UpdatePermission(BusinessObjects.PermissionKeys.SalesInvoice.Update)]
    [DeletePermission(BusinessObjects.PermissionKeys.SalesInvoice.Delete)]
    [LookupScript("BusinessObjects.SalesInvoiceRow")]
    public sealed class SalesInvoiceRow : Row, IIdRow
    {        
            #region Sales Invoice Id
            [DisplayName("Sales Invoice Id"), Column("SalesInvoiceID"), Identity, Hidden]
            public Int32? SalesInvoiceId { get { return Fields.SalesInvoiceId[this]; } set { Fields.SalesInvoiceId[this] = value; } }
            public partial class RowFields { public Int32Field SalesInvoiceId; }
            #endregion SalesInvoiceId
                
            #region Sales
            [DisplayName("Sales"), Column("SalesID"), ForeignKey("[dbo].[Sales]", "SalesID"), LeftJoin("jSales"), TextualField("SalesOrderId"), Hidden]
            ...
            [DisplayName("Sales Details Id"), Column("SalesDetailsID"), Hidden]
            ...
            #region Is Picked
            [DisplayName("Is Picked"), NotNull, Hidden]
            ...
            #region Location Id
            [DisplayName("Location Id"), Column("LocationID"), Hidden]
            ...
            [DisplayName("Pick Sales Order Id"), Column("PickSalesOrderID"), Hidden]
    ...
    #region Foreign Fields
                ...
                [DisplayName("Price"), Expression("jUomAndPrice.[Price]")]
    ...
    {
    get { return Fields.SalesInvoiceId; }
    }
    ...
    {
    public RowFields()
    : base("[dbo].[SalesInvoice]")
    {
    LocalTextPrefix = "BusinessObjects.SalesInvoice";
    }
    }
    #endregion RowFields
    }
