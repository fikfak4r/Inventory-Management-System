...
namespace InventoryManagement.BusinessObjects {
    ...
    export class TransferStockGrid extends Serenity.EntityGrid<StockRow, any> {
        protected getColumnsKey() { return 'BusinessObjects.TransferStock'; }
        protected getDialogType() { return TransferStockDialog; }
