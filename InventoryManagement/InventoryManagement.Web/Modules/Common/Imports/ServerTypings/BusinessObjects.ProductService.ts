namespace InventoryManagement.BusinessObjects {
    export namespace ProductService {
        ...
        export declare function AddSupplier(request: ProductSupplierRequest, onSuccess?: (response: Serenity.ServiceResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        ...
        export namespace Methods {
            ...
            export declare const AddSupplier: string;
        }
