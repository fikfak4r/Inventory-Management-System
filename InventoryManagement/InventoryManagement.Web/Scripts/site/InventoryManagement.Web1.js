        ...
        var PurchasesDialog = (function (_super) {
            ...
            PurchasesDialog.prototype.loadEntity = function (entity) {
                ...
                if (this.isNewOrDeleted()) {
                    ...
                    this.toolbar.findButton("complete-purchase").hide();
                    this.toolbar.findButton("reopen-purchase").hide();
                    this.toolbar.findButton("simple-purchase").hide();
                    this.toolbar.findButton("advance-purchase").hide();
                }
                else {
                    ...
                    if (this.once) {
                        //   this.toolbar.findButton("simple-purchase").show();
                        //   this.toolbar.findButton("complete-purchase").show();
                        this.once = false;
                    }
                }
            ...
            PurchasesDialog.prototype.toggleCompleteReOpenButtons = function (isCompleted) {
                if (isCompleted) {
                    this.toolbar.findButton("reopen-purchase").show();
                    this.toolbar.findButton("complete-purchase").hide();
                }
                else {
                    this.toolbar.findButton("reopen-purchase").hide();
            ...
            PurchasesDialog.prototype.setToSimplePurchase = function () {
                this.toolbar.findButton("simple-purchase").hide();
                this.toolbar.findButton("advance-purchase").show();
                // this.toolbar.findButton("complete-purchase").show();
                // this.toolbar.findButton("reopen-purchase").hide();
    ...
    (function (BusinessObjects) {
        var PurchasesDetailsDialog = (function (_super) {
            ...
            PurchasesDetailsDialog.prototype.updateInterface = function () {
                _super.prototype.updateInterface.call(this);
                this.form.PurchasesId.value = BusinessObjects.GlobalScripts.purchasesId.toString();
            ...
            SalesDialog.prototype.updateInterface = function () {
                ...
                if (!this.isNewOrDeleted()) {
                    if (this.form.IsAdvanced.value == true) {
                        ...
                        this.setToSimpleSales();
                    if (this.form.Status.value == 'Fully Pickd') {
                        this.toggleCompleteReOpenButtons(true);
                    }
                    else
                        this.toggleCompleteReOpenButtons(false);
    ...
    (function (BusinessObjects) {
        var SupplierDialog = (function (_super) {
            ...
            function SupplierDialog() {
                ...
                this.productsGrid = new BusinessObjects.SupplierProductGrid(this.byId("ProductGrid"));
                this.tabs.bind("tabsactivate", function () { return _this.arrange(); });
            }
...
(function (InventoryManagement) {
    var BusinessObjects;
    (function (BusinessObjects) {
        var SuppplierProductDialog = (function (_super) {
            __extends(SuppplierProductDialog, _super);
            function SuppplierProductDialog() {
                _super.call(this);
                this.form = new BusinessObjects.ProductForm(this.idPrefix);
            }
            SuppplierProductDialog.prototype.getFormKey = function () { return BusinessObjects.ProductForm.formKey; };
            SuppplierProductDialog.prototype.getIdProperty = function () { return BusinessObjects.ProductRow.idProperty; };
            SuppplierProductDialog.prototype.getLocalTextPrefix = function () { return BusinessObjects.ProductRow.localTextPrefix; };
            SuppplierProductDialog.prototype.getNameProperty = function () { return BusinessObjects.ProductRow.nameProperty; };
            SuppplierProductDialog.prototype.getService = function () { return BusinessObjects.ProductService.baseUrl; };
            SuppplierProductDialog.prototype.updateInterface = function () {
                _super.prototype.updateInterface.call(this);
                Serenity.EditorUtils.setReadOnly(this.form.SupplierId, true);
            };
            SuppplierProductDialog = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.responsive()
            ], SuppplierProductDialog);
            return SuppplierProductDialog;
        }(Serenity.EntityDialog));
        BusinessObjects.SuppplierProductDialog = SuppplierProductDialog;
    })(BusinessObjects = InventoryManagement.BusinessObjects || (InventoryManagement.BusinessObjects = {}));
})(InventoryManagement || (InventoryManagement = {}));
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        var SupplierProductGrid = (function (_super) {
            ...
            SupplierProductGrid.prototype.getDialogType = function () { return BusinessObjects.SuppplierProductDialog; };
...
(function (InventoryManagement) {
    ...
    (function (Administration) {
        ...
        (function (AccountRow) {
            ...
            ['AccountId', 'Date', 'CompanyName', 'Address', 'Email', 'PhoneNumber', 'WebsiteAddress'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        [['ProductId', function () { return Serenity.LookupEditor; }], ['Quantity', function () { return Serenity.DecimalEditor; }], ['Unit', function () { return Serenity.StringEditor; }]].forEach(function (x) { return Object.defineProperty(AdjustStockForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BusinessObjects = InventoryManagement.BusinessObjects || (InventoryManagement.BusinessObjects = {}));
})(InventoryManagement || (InventoryManagement = {}));
var InventoryManagement;
(function (InventoryManagement) {
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (BankRow) {
            ...
            ['BankId', 'Date', 'BankName', 'AccountId', 'AccountDate', 'AccountCompanyName', 'AccountLogo', 'AccountAddress', 'AccountEmail', 'AccountPhoneNumber', 'AccountWebsiteAddress'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (BankService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                BankService[x] = function (r, s, o) { return Q.serviceRequest(BankService.baseUrl + '/' + x, r, s, o); };
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (BankTransactionRow) {
            ...
            ['BankTransactionId', 'BankId', 'Date', 'AccountType', 'CustomerId', 'SalesId', 'Amount', 'LocationId', 'SalesPymntDetailsId', 'BankDate', 'BankBankName', 'BankAccountId', 'CustomerName', 'CustomerPhoneNumber', 'CustomerEmail', 'CustomerWebsite', 'CustomerAddress', 'CustomerAccountId', 'CustomerAddress2', 'SalesOrderId', 'SalesDate', 'SalesCustomerId', 'SalesTotalAmount', 'SalesTotalAmountPaid', 'SalesTotalAmountLeft', 'SalesCostOfGoodsSold', 'SalesGrossProfit', 'SalesHasSalesDetails', 'SalesLocationId', 'SalesIsIntegerTrailingOrderIdWithPrefixSo', 'SalesStatus', 'SalesIsOpen', 'SalesIsInProgress', 'SalesIsFullyPicked', 'SalesIsFullyPaid', 'SalesIsInvoiced', 'SalesIsAdvanced'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (BankTransactionService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                BankTransactionService[x] = function (r, s, o) { return Q.serviceRequest(BankTransactionService.baseUrl + '/' + x, r, s, o); };
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (CostingInfoRow) {
            ...
            ['CostingInfoId', 'ProductId', 'Cost', 'ProductDate', 'ProductProductCode', 'ProductProductName', 'ProductBrandName', 'ProductProductCategoryId', 'ProductSupplierId', 'ProductLeastUnitName', 'ProductAccountId'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (CostingInfoService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                CostingInfoService[x] = function (r, s, o) { return Q.serviceRequest(CostingInfoService.baseUrl + '/' + x, r, s, o); };
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (CustomerLocationRow) {
            ...
            ['CustomersLocationsId', 'CustomerId', 'LocationId', 'AccountId', 'CustomerDate', 'CustomerName', 'CustomerPhoneNumber', 'CustomerEmail', 'CustomerWebsite', 'CustomerAddress', 'CustomerAccountId', 'CustomerAddress2', 'LocationAccountId', 'LocationDate', 'LocationPhoneNumber', 'LocationEmail', 'LocationWebsite', 'LocationLocationName', 'LocationAddress', 'LocationUserId', 'LocationIsVisible', 'AccountDate', 'AccountCompanyName', 'AccountLogo', 'AccountAddress', 'AccountEmail', 'AccountPhoneNumber', 'AccountWebsiteAddress'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (CustomerLocationService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                CustomerLocationService[x] = function (r, s, o) { return Q.serviceRequest(CustomerLocationService.baseUrl + '/' + x, r, s, o); };
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (CustomerRow) {
            ...
            ['Date', 'CustomerId', 'Name', 'FullName', 'PhoneNumber', 'Email', 'Website', 'Address', 'AccountId', 'Address2', 'AccountDate', 'AccountCompanyName', 'AccountLogo', 'AccountAddress', 'AccountEmail', 'AccountPhoneNumber', 'AccountWebsiteAddress', 'LocationList'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (PickSalesOrderRow) {
            ...
            ['PickSalesOrderId', 'SalesId', 'ProductId', 'SalesDetailsId', 'Quantity', 'Date', 'IsPicked', 'Amount', 'UomAndPriceId', 'UnitPrice', 'Discount', 'Cost', 'QuantitySold', 'CostOfGoodsSold', 'LocationId', 'SalesProfit', 'SalesOrderId', 'SalesDate', 'SalesCustomerId', 'SalesTotalAmount', 'SalesTotalAmountPaid', 'SalesTotalAmountLeft', 'SalesCostOfGoodsSold', 'SalesGrossProfit', 'SalesHasSalesDetails', 'SalesLocationId', 'SalesIsIntegerTrailingOrderIdWithPrefixSo', 'SalesStatus', 'SalesIsOpen', 'SalesIsInProgress', 'SalesIsFullyPicked', 'SalesIsFullyPaid', 'SalesIsInvoiced', 'SalesIsAdvanced', 'ProductDate', 'ProductProductCode', 'ProductProductName', 'ProductBrandName', 'ProductProductCategoryId', 'ProductSupplierId', 'ProductLeastUnitName', 'ProductAccountId', 'UomAndPriceProductId', 'UomAndPriceUnitName', 'UomAndPriceUnitMakeUp', 'UomAndPriceStandardUomid', 'UomAndPriceDiscontinued', 'UomAndPricePrice'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (PickSalesOrderService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                PickSalesOrderService[x] = function (r, s, o) { return Q.serviceRequest(PickSalesOrderService.baseUrl + '/' + x, r, s, o); };
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (ProductCategoryLocationRow) {
            ...
            ['ProdCatLoctnId', 'ProductCategoryId', 'LocationId', 'AccountId', 'ProductCategoryCategoryName', 'ProductCategoryDescription', 'ProductCategoryAccountId', 'LocationAccountId', 'LocationDate', 'LocationPhoneNumber', 'LocationEmail', 'LocationWebsite', 'LocationLocationName', 'LocationAddress', 'LocationUserId', 'LocationIsVisible', 'AccountDate', 'AccountCompanyName', 'AccountLogo', 'AccountAddress', 'AccountEmail', 'AccountPhoneNumber', 'AccountWebsiteAddress'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (ProductCategoryLocationService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                ProductCategoryLocationService[x] = function (r, s, o) { return Q.serviceRequest(ProductCategoryLocationService.baseUrl + '/' + x, r, s, o); };
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (ProductCategoryRow) {
            ...
            ['ProductCategoryId', 'CategoryName', 'Description', 'AccountId', 'AccountDate', 'AccountCompanyName', 'AccountLogo', 'AccountAddress', 'AccountEmail', 'AccountPhoneNumber', 'AccountWebsiteAddress', 'LocationList'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        [['Date', function () { return Serenity.DateEditor; }], ['SupplierId', function () { return Serenity.LookupEditor; }], ['ProductCategoryId', function () { return Serenity.LookupEditor; }], ['ProductName', function () { return Serenity.StringEditor; }], ['ProductCode', function () { return Serenity.StringEditor; }], ['BrandName', function () { return Serenity.StringEditor; }], ['LeastUnitName', function () { return Serenity.StringEditor; }], ['LocationList', function () { return Serenity.LookupEditor; }], ['AccountId', function () { return Serenity.LookupEditor; }], ['PurchasesUoMAndPriceList', function () { return BusinessObjects.PurchasesUoMAndPriceEditor; }], ['SalesUoMAndPriceList', function () { return BusinessObjects.SalesUoMAndPriceEditor; }]].forEach(function (x) { return Object.defineProperty(ProductForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BusinessObjects = InventoryManagement.BusinessObjects || (InventoryManagement.BusinessObjects = {}));
})(InventoryManagement || (InventoryManagement = {}));
var InventoryManagement;
(function (InventoryManagement) {
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (ProductLocationRow) {
            ...
            ['ProductsLocationsId', 'ProductId', 'LocationId', 'AccountId', 'ProductDate', 'ProductProductCode', 'ProductProductName', 'ProductBrandName', 'ProductProductCategoryId', 'ProductSupplierId', 'ProductLeastUnitName', 'ProductAccountId', 'LocationAccountId', 'LocationDate', 'LocationPhoneNumber', 'LocationEmail', 'LocationWebsite', 'LocationLocationName', 'LocationAddress', 'LocationUserId', 'AccountDate', 'AccountCompanyName', 'AccountLogo', 'AccountAddress', 'AccountEmail', 'AccountPhoneNumber', 'AccountWebsiteAddress'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (ProductRow) {
            ...
            ['ProductId', 'Date', 'ProductCode', 'ProductName', 'BrandName', 'ProductCategoryId', 'SupplierId', 'LeastUnitName', 'AccountId', 'ProductCategoryCategoryName', 'ProductCategoryDescription', 'ProductCategoryAccountId', 'SupplierDate', 'SupplierSupplierName', 'SupplierPhoneNumber', 'SupplierFax', 'SupplierEmail', 'SupplierWebsite', 'SupplierAddress', 'SupplierNote', 'SupplierAccountId', 'AccountDate', 'AccountCompanyName', 'AccountLogo', 'AccountAddress', 'AccountEmail', 'AccountPhoneNumber', 'AccountWebsiteAddress', 'PurchasesUoMAndPriceList', 'SalesUoMAndPriceList', 'Pricing', 'LocationList'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        [['PurchasesId', function () { return Serenity.IntegerEditor; }], ['Date', function () { return Serenity.DateEditor; }], ['ProductId', function () { return Serenity.LookupEditor; }], ['UomAndPriceId', function () { return Serenity.LookupEditor; }], ['Quantity', function () { return Serenity.IntegerEditor; }], ['UnitPrice', function () { return Serenity.DecimalEditor; }], ['Discount', function () { return Serenity.DecimalEditor; }], ['Amount', function () { return Serenity.DecimalEditor; }], ['LocationId', function () { return Serenity.IntegerEditor; }], ['IsReceived', function () { return Serenity.BooleanEditor; }]].forEach(function (x) { return Object.defineProperty(PurchasesDetailsForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BusinessObjects = InventoryManagement.BusinessObjects || (InventoryManagement.BusinessObjects = {}));
})(InventoryManagement || (InventoryManagement = {}));
var InventoryManagement;
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (PurchasesDetailsRow) {
            ...
            ['PurchasesDetailsId', 'PurchasesId', 'Date', 'ProductId', 'Quantity', 'UomAndPriceId', 'UnitPrice', 'Discount', 'Amount', 'LocationId', 'IsReceived', 'PurchasesOrderId', 'PurchasesDate', 'PurchasesSupplierId', 'PurchasesTotalAmount', 'PurchasesTotalAmountPaid', 'PurchasesTotalAmountLeft', 'PurchasesHasPurchasesDetails', 'PurchasesLocationId', 'PurchasesIsIntegerTrailingOrderIdWithPrefixPo', 'PurchasesStatus', 'PurchasesIsOpen', 'PurchasesIsInProgress', 'PurchasesIsFullyReceived', 'PurchasesIsFullyPaid', 'PurchasesIsAdvanced', 'ProductDate', 'ProductProductCode', 'ProductProductName', 'ProductBrandName', 'ProductProductCategoryId', 'ProductSupplierId', 'ProductLeastUnitName', 'ProductAccountId', 'UomAndPriceProductId', 'UomAndPriceUnitName', 'UomAndPriceUnitMakeUp', 'UomAndPriceStandardUomid', 'UomAndPriceDiscontinued', 'UomAndPricePrice'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (PurchasesDetailsService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                PurchasesDetailsService[x] = function (r, s, o) { return Q.serviceRequest(PurchasesDetailsService.baseUrl + '/' + x, r, s, o); };
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        [['PurchasesId', function () { return Serenity.IntegerEditor; }], ['OrderId', function () { return Serenity.StringEditor; }], ['Date', function () { return Serenity.DateEditor; }], ['SupplierId', function () { return Serenity.LookupEditor; }], ['TotalAmount', function () { return Serenity.DecimalEditor; }], ['TotalAmountPaid', function () { return Serenity.DecimalEditor; }], ['TotalAmountLeft', function () { return Serenity.DecimalEditor; }], ['HasPurchasesDetails', function () { return Serenity.BooleanEditor; }], ['LocationId', function () { return Serenity.LookupEditor; }], ['IsIntegerTrailingOrderIdWithPrefixPo', function () { return Serenity.BooleanEditor; }], ['Status', function () { return Serenity.StringEditor; }], ['IsOpen', function () { return Serenity.BooleanEditor; }], ['IsInProgress', function () { return Serenity.BooleanEditor; }], ['IsFullyReceived', function () { return Serenity.BooleanEditor; }], ['IsFullyPaid', function () { return Serenity.BooleanEditor; }], ['IsAdvanced', function () { return Serenity.BooleanEditor; }]].forEach(function (x) { return Object.defineProperty(PurchasesForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BusinessObjects = InventoryManagement.BusinessObjects || (InventoryManagement.BusinessObjects = {}));
})(InventoryManagement || (InventoryManagement = {}));
var InventoryManagement;
(function (InventoryManagement) {
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (PurchasesPaymentDetailsRow) {
            ...
            ['PurchPymntDetailsId', 'PurchasesId', 'Date', 'TotalAmount', 'AmountPaid', 'AmountLeft', 'IsTotalAmountRow', 'LocationId', 'PurchasesOrderId', 'PurchasesDate', 'PurchasesSupplierId', 'PurchasesTotalAmount', 'PurchasesTotalAmountPaid', 'PurchasesTotalAmountLeft', 'PurchasesHasPurchasesDetails', 'PurchasesLocationId', 'PurchasesIsIntegerTrailingOrderIdWithPrefixPo', 'PurchasesStatus', 'PurchasesIsOpen', 'PurchasesIsInProgress', 'PurchasesIsFullyReceived', 'PurchasesIsFullyPaid', 'PurchasesIsAdvanced'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (PurchasesPaymentDetailsService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                PurchasesPaymentDetailsService[x] = function (r, s, o) { return Q.serviceRequest(PurchasesPaymentDetailsService.baseUrl + '/' + x, r, s, o); };
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (PurchasesRow) {
            ...
            ['PurchasesId', 'OrderId', 'Date', 'SupplierId', 'TotalAmount', 'TotalAmountPaid', 'TotalAmountLeft', 'HasPurchasesDetails', 'LocationId', 'IsIntegerTrailingOrderIdWithPrefixPo', 'Status', 'IsOpen', 'IsInProgress', 'IsFullyReceived', 'IsFullyPaid', 'IsAdvanced', 'SupplierDate', 'SupplierSupplierName', 'SupplierPhoneNumber', 'SupplierFax', 'SupplierEmail', 'SupplierWebsite', 'SupplierAddress', 'SupplierNote', 'SupplierAccountId', 'LocationAccountId', 'LocationDate', 'LocationPhoneNumber', 'LocationEmail', 'LocationWebsite', 'LocationLocationName', 'LocationAddress', 'LocationUserId'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (PurchasesService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List', 'CompletePurchase', 'ReopenOrder', 'ConvertToAdvancedPurchase', 'ConvertToSimplePurchase'].forEach(function (x) {
                PurchasesService[x] = function (r, s, o) { return Q.serviceRequest(PurchasesService.baseUrl + '/' + x, r, s, o); };
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        [['UnitName', function () { return Serenity.StringEditor; }], ['UnitMakeUp', function () { return Serenity.DecimalEditor; }], ['Price', function () { return Serenity.DecimalEditor; }], ['Discontinued', function () { return Serenity.BooleanEditor; }]].forEach(function (x) { return Object.defineProperty(PurchasesUoMAndPriceForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BusinessObjects = InventoryManagement.BusinessObjects || (InventoryManagement.BusinessObjects = {}));
})(InventoryManagement || (InventoryManagement = {}));
var InventoryManagement;
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (PurchasesUoMAndPriceRow) {
            ...
            ['UomAndPriceId', 'ProductId', 'UnitName', 'UnitMakeUp', 'StandardUomid', 'Discontinued', 'Price', 'ProductDate', 'ProductProductCode', 'ProductProductName', 'ProductBrandName', 'ProductProductCategoryId', 'ProductSupplierId', 'ProductLeastUnitName', 'ProductAccountId', 'StandardUomidProductId', 'StandardUomidStandardUnitName', 'StandardUomidDiscontinued', 'StandardUomidCost', 'UnitOfMeasurement', 'StandardUnitName'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (PurchasesUoMAndPriceService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                PurchasesUoMAndPriceService[x] = function (r, s, o) { return Q.serviceRequest(PurchasesUoMAndPriceService.baseUrl + '/' + x, r, s, o); };
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        [['PurchasesId', function () { return Serenity.IntegerEditor; }], ['PurchasesDetailsId', function () { return Serenity.IntegerEditor; }], ['Date', function () { return Serenity.DateEditor; }], ['ProductId', function () { return Serenity.LookupEditor; }], ['UomAndPriceId', function () { return Serenity.LookupEditor; }], ['Quantity', function () { return Serenity.DecimalEditor; }], ['UnitPrice', function () { return Serenity.DecimalEditor; }], ['Discount', function () { return Serenity.DecimalEditor; }], ['Amount', function () { return Serenity.DecimalEditor; }], ['IsReceived', function () { return Serenity.BooleanEditor; }], ['LocationId', function () { return Serenity.IntegerEditor; }]].forEach(function (x) { return Object.defineProperty(ReceivePurchasesForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BusinessObjects = InventoryManagement.BusinessObjects || (InventoryManagement.BusinessObjects = {}));
})(InventoryManagement || (InventoryManagement = {}));
var InventoryManagement;
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (ReceivePurchasesRow) {
            ...
            ['ReceivePurchasesId', 'PurchasesId', 'ProductId', 'PurchasesDetailsId', 'Quantity', 'Date', 'IsReceived', 'Amount', 'UnitPrice', 'UomAndPriceId', 'Discount', 'LocationId', 'PurchasesOrderId', 'PurchasesDate', 'PurchasesSupplierId', 'PurchasesTotalAmount', 'PurchasesTotalAmountPaid', 'PurchasesTotalAmountLeft', 'PurchasesHasPurchasesDetails', 'PurchasesLocationId', 'PurchasesIsIntegerTrailingOrderIdWithPrefixPo', 'PurchasesStatus', 'PurchasesIsOpen', 'PurchasesIsInProgress', 'PurchasesIsFullyReceived', 'PurchasesIsFullyPaid', 'PurchasesIsAdvanced', 'ProductDate', 'ProductProductCode', 'ProductProductName', 'ProductBrandName', 'ProductProductCategoryId', 'ProductSupplierId', 'ProductLeastUnitName', 'ProductAccountId', 'UomAndPriceProductId', 'UomAndPriceUnitName', 'UomAndPriceUnitMakeUp', 'UomAndPriceStandardUomid', 'UomAndPriceDiscontinued', 'UomAndPricePrice'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (ReceivePurchasesService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                ReceivePurchasesService[x] = function (r, s, o) { return Q.serviceRequest(ReceivePurchasesService.baseUrl + '/' + x, r, s, o); };
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        [['ProductId', function () { return Serenity.LookupEditor; }], ['ReorderPointValue', function () { return Serenity.DecimalEditor; }]].forEach(function (x) { return Object.defineProperty(ReorderPointForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BusinessObjects = InventoryManagement.BusinessObjects || (InventoryManagement.BusinessObjects = {}));
})(InventoryManagement || (InventoryManagement = {}));
var InventoryManagement;
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (ReorderPointRow) {
            ...
            ['ReorderPointId', 'ProductId', 'ReorderPointValue', 'ProductDate', 'ProductProductCode', 'ProductProductName', 'ProductBrandName', 'ProductProductCategoryId', 'ProductSupplierId', 'ProductLeastUnitName', 'ProductAccountId'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (ReorderPointService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                ReorderPointService[x] = function (r, s, o) { return Q.serviceRequest(ReorderPointService.baseUrl + '/' + x, r, s, o); };
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (RestockRow) {
            ...
            ['ReStockId', 'ProductId', 'Date', 'RtnInwardsDtlsId', 'SalesId', 'Quantity', 'UomAndPriceId', 'IsRestocked', 'LocationId', 'ProductDate', 'ProductProductCode', 'ProductProductName', 'ProductBrandName', 'ProductProductCategoryId', 'ProductSupplierId', 'ProductLeastUnitName', 'ProductAccountId', 'UomAndPriceProductId', 'UomAndPriceUnitName', 'UomAndPriceUnitMakeUp', 'UomAndPriceStandardUomid', 'UomAndPriceDiscontinued', 'UomAndPricePrice'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (RestockService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                RestockService[x] = function (r, s, o) { return Q.serviceRequest(RestockService.baseUrl + '/' + x, r, s, o); };
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        [['Date', function () { return Serenity.DateEditor; }], ['ProductId', function () { return Serenity.LookupEditor; }], ['Quantity', function () { return Serenity.IntegerEditor; }], ['UomAndPriceId', function () { return Serenity.LookupEditor; }], ['RtnInwardsId', function () { return Serenity.LookupEditor; }], ['SalesDetailsId', function () { return Serenity.LookupEditor; }], ['SalesId', function () { return Serenity.IntegerEditor; }], ['UnitPrice', function () { return Serenity.DecimalEditor; }], ['Discount', function () { return Serenity.DecimalEditor; }], ['Amount', function () { return Serenity.DecimalEditor; }], ['LocationId', function () { return Serenity.IntegerEditor; }]].forEach(function (x) { return Object.defineProperty(ReturnInwardsDetailsForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BusinessObjects = InventoryManagement.BusinessObjects || (InventoryManagement.BusinessObjects = {}));
})(InventoryManagement || (InventoryManagement = {}));
var InventoryManagement;
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (ReturnInwardsDetailsRow) {
            ...
            ['RtnInwardsDtlsId', 'Date', 'ProductId', 'RtnInwardsId', 'SalesDetailsId', 'SalesId', 'Quantity', 'UnitPrice', 'Amount', 'Discount', 'UomAndPriceId', 'LocationId', 'ProductDate', 'ProductProductCode', 'ProductProductName', 'ProductBrandName', 'ProductProductCategoryId', 'ProductSupplierId', 'ProductLeastUnitName', 'ProductAccountId', 'RtnInwardsDate', 'RtnInwardsSalesId', 'RtnInwardsTotalAmount', 'RtnInwardsTotalFee', 'RtnInwardsTotalAmountRefunded', 'RtnInwardsTotalCredit', 'SalesDetailsSalesId', 'SalesDetailsDate', 'SalesDetailsProductId', 'SalesDetailsUomAndPriceId', 'SalesDetailsUnitPrice', 'SalesDetailsDiscount', 'SalesDetailsAmount', 'SalesDetailsQuantity', 'SalesDetailsLocationId', 'SalesDetailsCost', 'SalesDetailsIsPicked', 'UomAndPriceProductId', 'UomAndPriceUnitName', 'UomAndPriceUnitMakeUp', 'UomAndPriceStandardUomid', 'UomAndPriceDiscontinued', 'UomAndPricePrice'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (ReturnInwardsDetailsService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                ReturnInwardsDetailsService[x] = function (r, s, o) { return Q.serviceRequest(ReturnInwardsDetailsService.baseUrl + '/' + x, r, s, o); };
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (ReturnInwardsPaymentRow) {
            ...
            ['RtnInwardsPaymentId', 'RtnInwardsId', 'SalesId', 'Date', 'Amount', 'AmountRefunded', 'Fee', 'Credit', 'RtnInwardsDate', 'RtnInwardsSalesId', 'RtnInwardsTotalAmount', 'RtnInwardsTotalFee', 'RtnInwardsTotalAmountRefunded', 'RtnInwardsTotalCredit'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (ReturnInwardsPaymentService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                ReturnInwardsPaymentService[x] = function (r, s, o) { return Q.serviceRequest(ReturnInwardsPaymentService.baseUrl + '/' + x, r, s, o); };
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (ReturnInwardsRow) {
            ...
            ['RtnInwardsId', 'Date', 'SalesId', 'TotalAmount', 'TotalFee', 'TotalAmountRefunded', 'TotalCredit', 'SalesOrderId', 'SalesDate', 'SalesCustomerId', 'SalesTotalAmount', 'SalesTotalAmountPaid', 'SalesTotalAmountLeft', 'SalesCostOfGoodsSold', 'SalesGrossProfit', 'SalesHasSalesDetails', 'SalesLocationId', 'SalesIsIntegerTrailingOrderIdWithPrefixSo', 'SalesStatus', 'SalesIsOpen', 'SalesIsInProgress', 'SalesIsFullyPicked', 'SalesIsFullyPaid', 'SalesIsInvoiced', 'SalesIsAdvanced'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (ReturnInwardsService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                ReturnInwardsService[x] = function (r, s, o) { return Q.serviceRequest(ReturnInwardsService.baseUrl + '/' + x, r, s, o); };
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        [['Date', function () { return Serenity.DateEditor; }], ['ProductId', function () { return Serenity.LookupEditor; }], ['RtnOutwardsId', function () { return Serenity.LookupEditor; }], ['PurchasesDetailsId', function () { return Serenity.IntegerEditor; }], ['PurchasesId', function () { return Serenity.IntegerEditor; }], ['Quantity', function () { return Serenity.DecimalEditor; }], ['UomAndPriceId', function () { return Serenity.LookupEditor; }], ['UnitPrice', function () { return Serenity.DecimalEditor; }], ['Amount', function () { return Serenity.DecimalEditor; }], ['LocationId', function () { return Serenity.IntegerEditor; }]].forEach(function (x) { return Object.defineProperty(ReturnOutwardsDetailsForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BusinessObjects = InventoryManagement.BusinessObjects || (InventoryManagement.BusinessObjects = {}));
})(InventoryManagement || (InventoryManagement = {}));
var InventoryManagement;
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (ReturnOutwardsDetailsRow) {
            ...
            ['RtnOutwardsDtlsId', 'Date', 'ProductId', 'RtnOutwardsId', 'PurchasesDetailsId', 'PurchasesId', 'Quantity', 'UnitPrice', 'Amount', 'Discount', 'UomAndPriceId', 'LocationId', 'ProductDate', 'ProductProductCode', 'ProductProductName', 'ProductBrandName', 'ProductProductCategoryId', 'ProductSupplierId', 'ProductLeastUnitName', 'ProductAccountId', 'RtnOutwardsDate', 'RtnOutwardsPurchasesId', 'RtnOutwardsTotalAmount', 'RtnOutwardsTotalFee', 'RtnOutwardsTotalAmountRefunded', 'RtnOutwardsTotalCredit', 'UomAndPriceProductId', 'UomAndPriceUnitName', 'UomAndPriceUnitMakeUp', 'UomAndPriceStandardUomid', 'UomAndPriceDiscontinued', 'UomAndPricePrice'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (ReturnOutwardsDetailsService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                ReturnOutwardsDetailsService[x] = function (r, s, o) { return Q.serviceRequest(ReturnOutwardsDetailsService.baseUrl + '/' + x, r, s, o); };
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (ReturnOutwardsPaymentRow) {
            ...
            ['RtnOutwardsPaymentId', 'RtnOutwardsId', 'PurchasesId', 'Date', 'Amount', 'AmountRefunded', 'Fee', 'Credit', 'RtnOutwardsDate', 'RtnOutwardsPurchasesId', 'RtnOutwardsTotalAmount', 'RtnOutwardsTotalFee', 'RtnOutwardsTotalAmountRefunded', 'RtnOutwardsTotalCredit'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (ReturnOutwardsPaymentService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                ReturnOutwardsPaymentService[x] = function (r, s, o) { return Q.serviceRequest(ReturnOutwardsPaymentService.baseUrl + '/' + x, r, s, o); };
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (ReturnOutwardsRow) {
            ...
            ['RtnOutwardsId', 'Date', 'PurchasesId', 'TotalAmount', 'TotalFee', 'TotalAmountRefunded', 'TotalCredit', 'PurchasesOrderId', 'PurchasesDate', 'PurchasesSupplierId', 'PurchasesTotalAmount', 'PurchasesTotalAmountPaid', 'PurchasesTotalAmountLeft', 'PurchasesHasPurchasesDetails', 'PurchasesLocationId', 'PurchasesIsIntegerTrailingOrderIdWithPrefixPo', 'PurchasesStatus', 'PurchasesIsOpen', 'PurchasesIsInProgress', 'PurchasesIsFullyReceived', 'PurchasesIsFullyPaid', 'PurchasesIsAdvanced'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (ReturnOutwardsService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                ReturnOutwardsService[x] = function (r, s, o) { return Q.serviceRequest(ReturnOutwardsService.baseUrl + '/' + x, r, s, o); };
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        [['SalesId', function () { return Serenity.IntegerEditor; }], ['Date', function () { return Serenity.DateEditor; }], ['ProductId', function () { return Serenity.LookupEditor; }], ['Quantity', function () { return Serenity.IntegerEditor; }], ['UomAndPriceId', function () { return Serenity.LookupEditor; }], ['UnitPrice', function () { return Serenity.DecimalEditor; }], ['Discount', function () { return Serenity.DecimalEditor; }], ['Amount', function () { return Serenity.DecimalEditor; }]].forEach(function (x) { return Object.defineProperty(SalesDetailsForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BusinessObjects = InventoryManagement.BusinessObjects || (InventoryManagement.BusinessObjects = {}));
})(InventoryManagement || (InventoryManagement = {}));
var InventoryManagement;
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (SalesDetailsRow) {
            ...
            ['SalesDetailsId', 'SalesId', 'Date', 'ProductId', 'UomAndPriceId', 'UnitPrice', 'Discount', 'Amount', 'Quantity', 'LocationId', 'Cost', 'IsPicked', 'SalesOrderId', 'SalesDate', 'SalesCustomerId', 'SalesTotalAmount', 'SalesTotalAmountPaid', 'SalesTotalAmountLeft', 'SalesCostOfGoodsSold', 'SalesGrossProfit', 'SalesHasSalesDetails', 'SalesLocationId', 'SalesIsIntegerTrailingOrderIdWithPrefixSo', 'SalesStatus', 'SalesIsOpen', 'SalesIsInProgress', 'SalesIsFullyPicked', 'SalesIsFullyPaid', 'SalesIsInvoiced', 'SalesIsAdvanced', 'ProductDate', 'ProductProductCode', 'ProductProductName', 'ProductBrandName', 'ProductProductCategoryId', 'ProductSupplierId', 'ProductLeastUnitName', 'ProductAccountId', 'UomAndPriceProductId', 'UomAndPriceUnitName', 'UomAndPriceUnitMakeUp', 'UomAndPriceStandardUomid', 'UomAndPriceDiscontinued', 'UomAndPricePrice', 'LocationAccountId', 'LocationDate', 'LocationPhoneNumber', 'LocationEmail', 'LocationWebsite', 'LocationLocationName', 'LocationAddress', 'LocationUserId'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (SalesDetailsService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                SalesDetailsService[x] = function (r, s, o) { return Q.serviceRequest(SalesDetailsService.baseUrl + '/' + x, r, s, o); };
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (SalesInvoiceRow) {
            ...
            ['SalesInvoiceId', 'SalesId', 'ProductId', 'SalesDetailsId', 'Quantity', 'Date', 'IsPicked', 'Amount', 'UomAndPriceId', 'Discount', 'LocationId', 'PickSalesOrderId', 'UnitPrice', 'SalesOrderId', 'SalesDate', 'SalesCustomerId', 'SalesTotalAmount', 'SalesTotalAmountPaid', 'SalesTotalAmountLeft', 'SalesCostOfGoodsSold', 'SalesGrossProfit', 'SalesHasSalesDetails', 'SalesLocationId', 'SalesIsIntegerTrailingOrderIdWithPrefixSo', 'SalesStatus', 'SalesIsOpen', 'SalesIsInProgress', 'SalesIsFullyPicked', 'SalesIsFullyPaid', 'SalesIsInvoiced', 'SalesIsAdvanced', 'ProductDate', 'ProductProductCode', 'ProductProductName', 'ProductBrandName', 'ProductProductCategoryId', 'ProductSupplierId', 'ProductLeastUnitName', 'ProductAccountId', 'UomAndPriceProductId', 'UomAndPriceUnitName', 'UomAndPriceUnitMakeUp', 'UomAndPriceStandardUomid', 'UomAndPriceDiscontinued', 'UomAndPricePrice'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (SalesInvoiceService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                SalesInvoiceService[x] = function (r, s, o) { return Q.serviceRequest(SalesInvoiceService.baseUrl + '/' + x, r, s, o); };
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (SalesPaymentDetailsRow) {
            ...
            ['SalesPymntDetailsId', 'SalesId', 'Date', 'TotalAmount', 'AmountPaid', 'AmountLeft', 'IsTotalAmountRow', 'LocationId', 'PaymentMode', 'BankId', 'SalesOrderId', 'SalesDate', 'SalesCustomerId', 'SalesTotalAmount', 'SalesTotalAmountPaid', 'SalesTotalAmountLeft', 'SalesCostOfGoodsSold', 'SalesGrossProfit', 'SalesHasSalesDetails', 'SalesLocationId', 'SalesIsIntegerTrailingOrderIdWithPrefixSo', 'SalesStatus', 'SalesIsOpen', 'SalesIsInProgress', 'SalesIsFullyPicked', 'SalesIsFullyPaid', 'SalesIsInvoiced', 'SalesIsAdvanced', 'LocationAccountId', 'LocationDate', 'LocationPhoneNumber', 'LocationEmail', 'LocationWebsite', 'LocationLocationName', 'LocationAddress', 'LocationUserId', 'BankDate', 'BankBankName', 'BankAccountId'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (SalesPaymentDetailsService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                SalesPaymentDetailsService[x] = function (r, s, o) { return Q.serviceRequest(SalesPaymentDetailsService.baseUrl + '/' + x, r, s, o); };
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (SalesRow) {
            ...
            ['SalesId', 'OrderId', 'Date', 'CustomerId', 'TotalAmount', 'TotalAmountPaid', 'TotalAmountLeft', 'CostOfGoodsSold', 'GrossProfit', 'HasSalesDetails', 'LocationId', 'IsIntegerTrailingOrderIdWithPrefixSo', 'Status', 'IsOpen', 'IsInProgress', 'IsFullyPicked', 'IsFullyPaid', 'IsInvoiced', 'IsAdvanced', 'CustomerName', 'CustomerPhoneNumber', 'CustomerEmail', 'CustomerWebsite', 'CustomerAddress', 'CustomerAccountId', 'CustomerAddress2', 'LocationAccountId', 'LocationDate', 'LocationPhoneNumber', 'LocationEmail', 'LocationWebsite', 'LocationLocationName', 'LocationAddress', 'LocationUserId'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (SalesService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                SalesService[x] = function (r, s, o) { return Q.serviceRequest(SalesService.baseUrl + '/' + x, r, s, o); };
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        [['ProductId', function () { return Serenity.LookupEditor; }], ['UnitName', function () { return Serenity.StringEditor; }], ['UnitMakeUp', function () { return Serenity.DecimalEditor; }], ['StandardUomid', function () { return Serenity.LookupEditor; }], ['Price', function () { return Serenity.DecimalEditor; }], ['Discontinued', function () { return Serenity.BooleanEditor; }]].forEach(function (x) { return Object.defineProperty(SalesUoMAndPriceForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BusinessObjects = InventoryManagement.BusinessObjects || (InventoryManagement.BusinessObjects = {}));
})(InventoryManagement || (InventoryManagement = {}));
var InventoryManagement;
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (SalesUoMAndPriceRow) {
            ...
            ['UomAndPriceId', 'ProductId', 'UnitName', 'UnitMakeUp', 'StandardUomid', 'Discontinued', 'Price', 'ProductDate', 'ProductProductCode', 'ProductProductName', 'ProductBrandName', 'ProductProductCategoryId', 'ProductSupplierId', 'ProductLeastUnitName', 'ProductAccountId', 'StandardUomidProductId', 'StandardUomidStandardUnitName', 'StandardUomidDiscontinued', 'StandardUomidCost'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (SalesUoMAndPriceService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                SalesUoMAndPriceService[x] = function (r, s, o) { return Q.serviceRequest(SalesUoMAndPriceService.baseUrl + '/' + x, r, s, o); };
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (StandardUoMRow) {
            ...
            ['StandardUomid', 'ProductId', 'StandardUnitName', 'Discontinued', 'Cost', 'ProductDate', 'ProductProductCode', 'ProductProductName', 'ProductBrandName', 'ProductProductCategoryId', 'ProductSupplierId', 'ProductLeastUnitName', 'ProductAccountId'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (StandardUoMService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                StandardUoMService[x] = function (r, s, o) { return Q.serviceRequest(StandardUoMService.baseUrl + '/' + x, r, s, o); };
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (StockRow) {
            ...
            ['StockId', 'ProductId', 'Quantity', 'QuantityInUnit', 'LocationId', 'ProductDate', 'ProductProductCode', 'ProductProductName', 'ProductBrandName', 'ProductProductCategoryId', 'ProductSupplierId', 'ProductLeastUnitName', 'ProductAccountId', 'LocationAccountId', 'LocationDate', 'LocationPhoneNumber', 'LocationEmail', 'LocationWebsite', 'LocationLocationName', 'LocationAddress', 'LocationUserId', 'ProductCategory'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (StockService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                StockService[x] = function (r, s, o) { return Q.serviceRequest(StockService.baseUrl + '/' + x, r, s, o); };
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (SupplierLocationRow) {
            ...
            ['SuppliersLocationsId', 'SupplierId', 'LocationId', 'AccountId', 'SupplierDate', 'SupplierSupplierName', 'SupplierPhoneNumber', 'SupplierFax', 'SupplierEmail', 'SupplierWebsite', 'SupplierAddress', 'SupplierNote', 'SupplierAccountId', 'LocationAccountId', 'LocationDate', 'LocationPhoneNumber', 'LocationEmail', 'LocationWebsite', 'LocationLocationName', 'LocationAddress', 'LocationUserId', 'AccountDate', 'AccountCompanyName', 'AccountLogo', 'AccountAddress', 'AccountEmail', 'AccountPhoneNumber', 'AccountWebsiteAddress'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (SupplierLocationService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                SupplierLocationService[x] = function (r, s, o) { return Q.serviceRequest(SupplierLocationService.baseUrl + '/' + x, r, s, o); };
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (SupplierRow) {
            ...
            ['SupplierId', 'Date', 'SupplierName', 'PhoneNumber', 'Fax', 'Email', 'Website', 'Address', 'Note', 'AccountId', 'AccountDate', 'AccountCompanyName', 'AccountLogo', 'AccountAddress', 'AccountEmail', 'AccountPhoneNumber', 'AccountWebsiteAddress', 'LocationList'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        [['Date', function () { return Serenity.DateEditor; }], ['PurchasesId', function () { return Serenity.IntegerEditor; }], ['RtnOutwardsDtlsId', function () { return Serenity.LookupEditor; }], ['Quantity', function () { return Serenity.DecimalEditor; }], ['UomAndPriceId', function () { return Serenity.LookupEditor; }], ['IsUnstocked', function () { return Serenity.BooleanEditor; }], ['LocationId', function () { return Serenity.IntegerEditor; }]].forEach(function (x) { return Object.defineProperty(UnstockForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BusinessObjects = InventoryManagement.BusinessObjects || (InventoryManagement.BusinessObjects = {}));
})(InventoryManagement || (InventoryManagement = {}));
var InventoryManagement;
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (UnstockRow) {
            ...
            ['UnStockId', 'ProductId', 'Date', 'PurchasesId', 'RtnOutwardsDtlsId', 'Quantity', 'UomAndPriceId', 'IsUnstocked', 'LocationId', 'ProductDate', 'ProductProductCode', 'ProductProductName', 'ProductBrandName', 'ProductProductCategoryId', 'ProductSupplierId', 'ProductLeastUnitName', 'ProductAccountId', 'UomAndPriceProductId', 'UomAndPriceUnitName', 'UomAndPriceUnitMakeUp', 'UomAndPriceStandardUomid', 'UomAndPriceDiscontinued', 'UomAndPricePrice'].forEach(function (x) { return Fields[x] = x; });
...
(function (InventoryManagement) {
    ...
    (function (BusinessObjects) {
        ...
        (function (UnstockService) {
            ...
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                UnstockService[x] = function (r, s, o) { return Q.serviceRequest(UnstockService.baseUrl + '/' + x, r, s, o); };
